                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;">
                                                <strong>{{__("Approve An Appointment")}}</strong>
                                            </h1>
                                            <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br />
                                                {{__("Dear :name, your appointment for the service (:service) for the product (:product) has been approved, we're waiting for you on :date",
                                                        [
                                                            "name" => $appointment->user->name ,
                                                            "date" => $appointment->date->format('l jS \\of F Y h:i:s A'),
                                                            "product" => $appointment->product->title ,
